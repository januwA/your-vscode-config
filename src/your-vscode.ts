...
export class YourVscode {
   ...
   */
	...
	static revive(panel: vscode.WebviewPanel, extensionPath: string, globalState: vscode.Memento) {
		YourVscode.currentPanel = new YourVscode(panel, extensionPath, globalState);
	}
   ...
   */
	...
	private _getHtmlForWebview(webview: vscode.Webview) {
		// 主脚本的本地路径在webview中运行
		const scriptPathOnDisk = vscode.Uri.file(path.join(this._extensionPath, 'ui', 'main.js'));
